...
\begin{itemize}
\item	All the containers have the same size, 20 feet containers;
...
Different from the SSM in \cite{wang2014stowage}, there are different containers on the vessel at each port for C-SSP.
